...
export class VanInventoryTopupQueryDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ type: String, description: 'Business identifier for vanInventoryTopup' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ enum: VanInventoryTopupStatus, description: 'Filter by status', default: VanInventoryTopupStatus.DRAFT })
  @IsOptional()
